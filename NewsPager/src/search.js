...
const btn = $('searchBtn');
const articleNewsSearch = $('articleNewsSearch');
const whatSearched = $('whatSearched');

btn.addEventListener('click', searchIt);

async function getData() {
    var inputVal = $("search").value;
    whatSearched.innerHTML = ` ${inputVal} ...`;
    const url = `https://newsapi.org/v2/everything?q=${inputVal}&from=2022-06-20&sortBy=popularity&apiKey=4299ff3e93c44dce82d5d8353f974c5b`;
    ...
    articleNewsSearch.innerHTML = result;
        })
}
